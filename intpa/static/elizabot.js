...
ElizaBot.prototype.ajax_req = function(func, str){
	...
	console.log(str);
	console.log(func);
	var str = str.trim().split(' ').join('%20');
	console.log(str);
	$.ajax({
		type: 'POST',
		url: '/intpa/'+func +'/',
		...
		{	
			...
			if(func=="getweather"){
				...
				document.getElementById("image1").setAttribute("src", data.first);
				document.getElementById("image2").setAttribute("src", data.second);
				document.getElementById("image3").setAttribute("src", data.third);
				document.getElementById("image4").setAttribute("src", data.fourth);
				/*var img = $('<img />', {src : data.second});
    				img.appendTo('body');
    				img = $('<img />', {src : data.first});
    				img.appendTo('body');
    				img = $('<img />', {src : data.third});
    				img.appendTo('body');
    				img = $('<img />', {src : data.fourth});
    				img.appendTo('body');
    				*/
